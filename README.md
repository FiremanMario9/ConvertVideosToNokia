...
The file will appear as yourvideoname.oldextention.flv
If you wish, delete the old extention name. .flv is the correct extention.
Copy the video file to your nokia's "Video" folder. Make sure it is the SD card, not the internal storage. The internal storage is VERY limited, it only has 32 MB. Don't expect to copy anything of size to it. Even a short video will take up ALL of the internal storage.
Open the videos app on the nokia and click the video!
Alternativly, open the files app and go to the "Video" folder, and click on the file there.
